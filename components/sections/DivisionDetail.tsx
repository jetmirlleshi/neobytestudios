...
/**
 * Reusable detail template for a single division page.
 * Renders: Hero, Mission, Capabilities, Process, Tech stack, CTA.
 *
 * All per-division content is driven by the `division` prop (with some
 * generic copy — the studio is still tiny so we're not faking project
 * galleries that don't exist).
 */
...
export function DivisionDetail({ division: d }: Props) {
  return (
    <>
      ...
      <section className="relative px-6 py-24 md:px-12 md:py-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-10 max-w-3xl font-body text-lg leading-relaxed text-on-surface-variant md:text-xl">
            ...
            charge of turning raw intent into structured reality — operating at
            the intersection of classical craftsmanship and autonomous
            intelligence.
          </p>
        </div>
      </section>
            ...
            {d.capabilities.map((cap, i) => (
              ...
              >
                ...
                >
                  ...
                  <p className="font-body text-base text-on-background">
                    {cap}
                  </p>
                </GlassCard>
              </motion.div>
      ...
      {/* ============ Featured Artifacts (placeholder) ============ */}
      <section className="relative bg-surface-container-lowest px-6 py-24 md:px-12 md:py-32">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3">
            {[1, 2, 3].map((n) => (
              ...
              >
                ...
                >
                  <span
                    className="font-headline text-[10px] font-semibold uppercase tracking-[0.3em] text-on-surface-variant"
                  >
      ...
      <section className="relative isolate overflow-hidden px-6 py-24 md:px-12 md:py-32">
        ...
        >
          ...
          <p className="mt-6 max-w-xl font-body text-lg text-on-surface-variant">
            Open a channel with the studio. First contact is always free —
            signals travel at light-speed.
          </p>
          <div className="mt-10">
            <Button
              href="/contact"
